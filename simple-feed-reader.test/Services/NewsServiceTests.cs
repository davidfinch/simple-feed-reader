...
namespace simple_feed_reader.test.Services
{
    public class NewsServiceTests
    {
        ...
        {
            var mockMapper = new MapperConfiguration(cfg => cfg.AddProfile(new NewsStoryProfile()));
        ...
        public async Task Returns_News_Stories_Given_Valid_Uri()
        {
            ...
            // Act
            List<NewsStoryViewModel> result = await _newsService.GetNews(feedUrl);
        ...
        public void Throws_UriFormatException_Given_Malformed_Uri()
        {
            ...
            // Act & Assert
            Assert.ThrowsAsync<UriFormatException>(async () => await _newsService.GetNews(feedUrl));
        }
